...
///
/// Why not use [UnaryOperator] instead? That is a pure function
...
public interface UnaryOperation<T> {
    ...
    /// Wrap a [UnaryOperator] (plain Java version) as an [UnaryOperation]
    ...
    /// Get the pure Java [UnaryOperator] (just apply, no info() or ast())
    ...
    /// Helper method to turn this operation into an [AstNode], using op() and info()
