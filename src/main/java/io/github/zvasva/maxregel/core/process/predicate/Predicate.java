...
///
/// Why not use [java.util.function.Predicate] instead? That is a pure function
...
/// @param <B> The object that can be used to initialize this predicate, before [#test(Object)] is used.
///
/// @author Arvid Halma
