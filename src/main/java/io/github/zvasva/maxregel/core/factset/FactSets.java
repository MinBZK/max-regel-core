...
public class FactSets {
    ...
    /// Groups the [FactSet] by a specified field.
    ///
    ...
    /// Joins the current [FactSet] with another [FactSet] based on a specified field.
    ///
    ...
    /// A multiline string representation of a factset, only showing the [Term]s of the [Fact]s.
    /// @param facts the factset
    /// @return text
    ...
    /// A multiline string representation of a factset, showing the full [Fact] objects.
    /// @param facts the factset
    /// @return text
